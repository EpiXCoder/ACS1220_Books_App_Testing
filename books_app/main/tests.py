...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        author = Author.query.filter_by(name='Nora Roberts').one()
        self.assertIsNotNone(author)
        self.assertEqual(author.name, 'Nora Roberts')
    ...
    def test_create_genre(self):
        ...
        genre = Genre.query.filter_by(name='Paranormal Romance').one()
        self.assertIsNotNone(genre)
        self.assertEqual(genre.name, 'Paranormal Romance')
